...
/**
 * Density related but normalized to dimensionality rule.
 * @bug $sample_k > KNNVector->get_k() causes exception.
 */
class RuleDENSEDIM
{
  const RULE_DENSE_DEFAULT_ALPHA = 1.8;
  ...
  public function rule(KNNVector $node, KNNVector $neighbour_node, Array $options)
  {
    ...
    $neighbour_density = $neighbour_node->get_density_dim($this->sample_k);
